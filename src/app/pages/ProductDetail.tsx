            ...
            >
                ...
                <div className="relative z-10 text-center px-4">
                    ...
                    <div className="text-white/80 text-xs md:text-sm tracking-widest uppercase flex items-center justify-center gap-2" style={{ fontFamily: "'Lato', sans-serif" }}>
                        ...
                        <span>/</span>
                        <a href="/#products" className="hover:text-white transition">DÒNG BIA CAO CẤP</a>
                        <span>/</span>
                        <span className="text-[#C8963E] font-medium">{product.name}</span>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 py-16 md:py-24 flex flex-col lg:flex-row gap-12 lg:gap-20">
                ...
                <div className="w-full lg:w-1/2 font-light">
                    ...
                    <div className="flex items-center gap-2 mb-8 border-b border-gray-200 pb-6">
                        ...
                        <span className="text-gray-500 text-[15px]">({product.reviews || 0} đánh giá của khách hàng)</span>
                    </div>

                    <div className="text-gray-600 leading-relaxed mb-6">
                        <p className="mb-6 text-[16px] text-justify" style={{ fontFamily: "'Lato', sans-serif" }}>{product.desc}</p>
                        {product.details && product.details.length > 0 && (
                            <ul className="list-disc pl-5 space-y-3 text-[16px]">
                                {product.details.map((detail: any, idx) => (
                                    <li key={idx}>
                    ...
                    <div className="flex items-center gap-4 mb-10 text-xl mt-4">
                        <span className="text-[#1C1A14] font-medium text-[13px] tracking-widest uppercase">Giá: </span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 lg:gap-8">
                    {similarProducts.map((item) => (
                        <div key={item.id} className="flex flex-col items-center text-center group cursor-pointer">
                            ...
                            <span className="text-gray-400 text-xs mb-3 font-medium uppercase tracking-widest">{item.category} Beer</span>
            ...
            {showQR && (
                <div className="fixed inset-0 bg-black/60 z-[9999] flex items-center justify-center p-4">
                    <div className="bg-white p-6 rounded-xl shadow-2xl max-w-sm w-full relative animate-in fade-in zoom-in-95 duration-200">
                        ...
                        <h3 className="text-center font-bold text-lg mb-4 text-[#0F253F] font-['Josefin_Sans']">Quét mã Zalo để liên hệ</h3>
                        ...
                        <div className="text-center mt-4 text-sm text-gray-500">
                            Hoặc gọi số điện thoại: <span className="font-bold text-black">098 935 4444</span>
                        </div>
                    </div>
                </div>
            )}
